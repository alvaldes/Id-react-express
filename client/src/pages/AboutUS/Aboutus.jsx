...
import ImgDaniela from '../../assets/team/daniela.png'
import ImgPablo from '../../assets/team/pablo.png'


const aboutus = () => {
  document.title = "Id.uci.cu/Sobre Nosotros";
    return (
          ...
          <Box sx={{ width: "100%" }}>
            ...
            >
              ...
              <TeamCard
                ...
                email="riveroamanda311@gmail.com  "
                github="riveroamanda311"
              />
              <TeamCard
                img={ImgEduardo}
